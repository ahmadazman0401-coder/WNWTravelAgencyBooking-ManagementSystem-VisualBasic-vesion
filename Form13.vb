Public Class Form13
    ...
    Private Sub btnPayNow_Click(sender As Object, e As EventArgs) Handles btnPayNow.Click
        Dim cardholder As String = txtCardName.Text
        Dim cardNumber As String = txtCardNumber.Text
        Dim expiry As String = txtExpiry.Text
        Dim cvv As String = txtCVV.Text
        Dim address As String = txtAddress.Text
        Dim confirmationMsg As String

        If String.IsNullOrWhiteSpace(cardholder) Or String.IsNullOrWhiteSpace(cardNumber) Then
